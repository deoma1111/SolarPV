...
class TestSequence(models.Model):
	sequenceName =models.CharField(max_length = 20, null=True)
...
class PerformanceData(models.Model):
	...
	maxSystemVoltage =models.IntegerField(null=True)
...
class Certificate(models.Model):
	certNumber= models.AutoField(unique=True, primary_key = True)
